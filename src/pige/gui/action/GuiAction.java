...
//              getResource(CreateGui.imgPath + name + ".png");
      ...
      if (tooltip != null) {
         putValue(SHORT_DESCRIPTION, PigeLocales.bundleString(tooltip));
      }
