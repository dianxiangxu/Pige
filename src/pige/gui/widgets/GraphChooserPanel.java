 ...
 * @author Maxim
 */
public class GraphChooserPanel 
        extends JPanel {
   ...
   JButton    browse;
   private GraphDataLayer  defaultNet;
   
   
   public GraphChooserPanel(String title, GraphDataLayer _defaultNet) {
      super();
...
//    textField.setPreferredSize(new Dimension());
   ...
   public GraphDataLayer getDataLayer() {
      if ((useCurrent != null) && (useCurrent.isSelected())) {
         ...
         if (fileName == null || fileName.equals("")) {
            ...
            try {
               GraphDataLayer result = new GraphDataLayer(fileName);
               return result;
            } catch (Exception e) {
