...
//		System.out.println("Locale/country: "+locale+"/"+country);		  
		if (isLocaleSupported(locale, country)){
			try {
//				resourceBundle = ResourceBundle.getBundle("pigelocales/MessagesBundle", new Locale("zh", "CN"));
//				resourceBundle = ResourceBundle.getBundle("pigelocales/MessagesBundle", new Locale("en", "US"));
				resourceBundle = ResourceBundle.getBundle("pigelocales/MessagesBundle", new Locale(locale, country));
